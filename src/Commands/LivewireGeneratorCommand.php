...
namespace OpenSoftApp\BackEndGenerator\Commands;

use OpenSoftApp\BackEndGenerator\ModelGenerator;
...
abstract class LivewireGeneratorCommand extends Command
{
    ...
    public function __construct(Filesystem $files)
    {
        ...
        $this->files = $files;
        $this->unwantedColumns = config('back-end-generator.model.unwantedColumns', $this->unwantedColumns);
        $this->modelNamespace = config('back-end-generator.model.namespace', $this->modelNamespace);
        $this->controllerNamespace = config('back-end-generator.controller.namespace', $this->controllerNamespace);
        $this->livewireNamespace = config('back-end-generator.livewire.namespace', $this->livewireNamespace);
        $this->layout = config('back-end-generator.layout', $this->layout);
    }
    ...
    {
        $stub_path = config('back-end-generator.stub_path', 'default');
